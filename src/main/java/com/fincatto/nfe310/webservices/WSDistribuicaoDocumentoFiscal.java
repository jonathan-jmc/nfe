...
import com.fincatto.nfe310.classes.evento.distribuicaodfe.DistDFeInt;
import com.fincatto.nfe310.classes.evento.distribuicaodfe.NFeDistribuicaoDFe;
import com.fincatto.nfe310.classes.evento.distribuicaodfe.NFeDistribuicaoDFeSoap;
import com.fincatto.nfe310.classes.evento.distribuicaodfe.NfeDistDFeInteresse;
import com.fincatto.nfe310.classes.evento.distribuicaodfe.NfeDistDFeInteresseResponse;
import com.fincatto.nfe310.classes.evento.distribuicaodfe.ObjectFactory;
...
class WSDistribuicaoDocumentoFiscal {
    ...
    private DistDFeInt gerarDadosConsulta(final String cnpj, final String chave, final String nsu, final NFUnidadeFederativa unidadeFederativa) {
        ...
        /**
         * Segundo a NT2014.002_v1.02_WsNFeDistribuicaoDFe a partir de 09/01/2017 este campo serÃ¡ opcional
         */
    ...
    private RetDistDFeInt efetuaConsultaDocumentoFiscal(final DistDFeInt distDFeInt, final NFUnidadeFederativa unidadeFederativa) throws RemoteException, JAXBException, MalformedURLException {
        ...
        NfeDistDFeInteresse.NfeDadosMsg nfeDadosMsg = new ObjectFactory().createNfeDistDFeInteresseNfeDadosMsg();
